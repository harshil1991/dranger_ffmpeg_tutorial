...
CFLAGS:=-Wall -ggdb
LDFLAGS:=$(shell pkg-config --libs libavformat libavcodec libswresample libswscale libavutil sdl) -lm -lX11 -lvpx -lpthread -lx264 -lx265 -ltheoraenc -ltheoradec -lfdk-aac -lvorbis -lvdpau -lvorbisenc -lopus 
